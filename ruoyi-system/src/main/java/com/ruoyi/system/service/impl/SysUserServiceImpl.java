...
public class SysUserServiceImpl implements ISysUserService {
     ...
     *
     * @param queryString (like userId, nickName, phonenumber)
     * @return
     */
    @Override
    public List<SysUsersInfo> selectUsersInfoLike(String queryString, Integer queryNum) {
        HashMap<String, Object> params = new HashMap<String, Object>();
        params.put("queryString", queryString);
        params.put("queryNum", queryNum);
        return userMapper.selectUsersInfoLike(params);
    }
    ...
    public String selectUserType(Long userId) {
        return userMapper.selectUserType(userId);
    }

    /**
     * 根据userName查询该用户的用户类型
     *
     * @return 用户类型字符串
     */
    @Override
    public String selectUserTypeByUserName(String userName) {
        return userMapper.selectUserTypeByUserName(userName);
    }
     ...
     */
    @Override
    public SysUserBaseInfo selectUserBaseInfoById(Long userId) {
    ...
    @Override
    public List<SysUser> getAgent() {
        return userMapper.getAgent();
    }
